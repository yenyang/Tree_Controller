...
namespace Tree_Controller.Extensions
{
    using System;
    ...
    public abstract partial class ExtendedUISystemBase : UISystemBase
    {
        ...
        public ValueBindingHelper<T> CreateBinding<T>(string key, string setterKey, T initialValue, Action<T> updateCallBack = null)
        {
            ...
            var trigger = new TriggerBinding<T>(TreeControllerMod.Id, setterKey, helper.UpdateCallback, new GenericUIReader<T>());
        ...
        {
            var binding = new TriggerBinding<T1>(TreeControllerMod.Id, key, action, new GenericUIReader<T1>());
        ...
        {
            var binding = new TriggerBinding<T1, T2>(TreeControllerMod.Id, key, action, new GenericUIReader<T1>(), new GenericUIReader<T2>());
        ...
        {
            var binding = new TriggerBinding<T1, T2, T3>(TreeControllerMod.Id, key, action, new GenericUIReader<T1>(), new GenericUIReader<T2>(), new GenericUIReader<T3>());
        ...
        {
            var binding = new TriggerBinding<T1, T2, T3, T4>(TreeControllerMod.Id, key, action, new GenericUIReader<T1>(), new GenericUIReader<T2>(), new GenericUIReader<T3>(), new GenericUIReader<T4>());
