...
## Tree Growth
You may use the Tree Controller tools to pause or unpause the aging of trees that are already placed. If you use the Disable Tree Aging option this will automatically be added to trees other than Lumber. Trees will have a red circle around them while using the tree controller tools if their aging is paused.
