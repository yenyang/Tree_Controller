    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(TreeControllerSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.DisableTreeGrowth)), "Use buttons to Pause or Resume. Preseve Age Toggle always on. Toggle Hidden. Automatically pauses Tree Growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off, settings being reset or mod being removed. You can use the Tree Controller Tool to resume aging for existing trees." },
                { m_Setting.GetOptionLabelLocaleID(nameof(TreeControllerSettings.PauseTreeGrowthButton)), "Pause Tree Growth" },
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.PauseTreeGrowthButton)), "Preserve Age Toggle always on. Toggle Hidden. Automatically pauses Tree Growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off, settings being reset or mod being removed. You can use the Tree Controller Tool to resume aging for existing trees." },
                ...
                { m_Setting.GetOptionWarningLocaleID(nameof(TreeControllerSettings.ResumeTreeGrowthButton)), "The effects of this setting on existing trees continue even after deactivating it, settings being reset, or mod being removed. You can use the Tree Controller Tool to restart aging for existing trees." },
