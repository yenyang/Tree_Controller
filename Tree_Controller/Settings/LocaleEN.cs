    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(TreeControllerSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.ColorVariationSet)), "Sets of seasonal colors for Trees and Wild bushes. Vanilla is the base game. Yenyang's is my curated colors. Spring is green year round. Autumn is fall colors year round. Custom uses CSV files in the mod folder." },
