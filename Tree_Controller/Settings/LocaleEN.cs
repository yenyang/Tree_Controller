    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(TreeControllerSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(TreeControllerSettings.DisableTreeGrowth)), "Tree Growth Paused" },
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.DisableTreeGrowth)), "Use buttons to Pause or Resume. Vanilla button to \"Preserve Age\" will effectively always be enabled, but will be hidden from view. Automatically pauses Tree Growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off, settings being reset or mod being removed. You can use the Tree Controller Tool to resume aging for existing trees." },
                { m_Setting.GetOptionLabelLocaleID(nameof(TreeControllerSettings.PauseTreeGrowthButton)), "Pause Tree Growth" },
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.PauseTreeGrowthButton)), "Vanilla button to \"Preserve Age\" will effectively always be enabled, but will be hidden from view. Automatically pauses Tree Growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off, settings being reset or mod being removed. You can use the Tree Controller Tool to resume aging for existing trees." },
                { m_Setting.GetOptionWarningLocaleID(nameof(TreeControllerSettings.PauseTreeGrowthButton)), "This will automatically pause tree growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off, settings being reset or mod being removed." },
                { m_Setting.GetOptionLabelLocaleID(nameof(TreeControllerSettings.ResumeTreeGrowthButton)), "Resume Tree Growth" },
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.ResumeTreeGrowthButton)), "Preserve Age Toggle option available. The effects of this setting on existing trees continue even after deactivating it, settings being reset, or mod being removed. You can use the Tree Controller Tool to resume aging for existing trees." },
                { m_Setting.GetOptionWarningLocaleID(nameof(TreeControllerSettings.ResumeTreeGrowthButton)), "The effects of this setting on existing trees continue even after deactivating it, settings being reset, or mod being removed. You can use the Tree Controller Tool to resume aging for existing trees." },
                ...
                { "YY_TREE_CONTROLLER[min-slope]", "Min Slope" },
                { "YY_TREE_CONTROLLER[max-slope]", "Max Slope" },
                { "YY_TREE_CONTROLLER_DESCRIPTION[slope-down-arrow]", "Decrease slope by 5 degrees." },
                { "YY_TREE_CONTROLLER_DESCRIPTION[slope-up-arrow]", "Increase slope by 5 degrees." },
                ...
                { TooltipDescriptionKey("ProbabilityWeight"), "Increases or decreases the probability that this vegetation asset will be chosen randomly using this Set while placing single objects, brushing multiple objects, using line tool mode, curve tool mode, and Line Tool." },
