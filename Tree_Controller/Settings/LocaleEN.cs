    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(TreeControllerSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.DisableTreeGrowth)), "Preseve Age Toggle always on. Toggle Hidden. Automatically pauses Tree Growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off or settings being reset. You can use the Tree Controller Tool to restart aging for existing trees." },
                { m_Setting.GetOptionWarningLocaleID(nameof(TreeControllerSettings.DisableTreeGrowth)), "This will automatically pause tree growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off." },
