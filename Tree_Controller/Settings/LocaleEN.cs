    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(TreeControllerSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.ActivateDisableTreeGrowth)), "Preseve Age Toggle always on. Toggle Hidden. Automatically pauses Tree Growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off or settings being reset. You can use the Tree Controller Tool to restart aging for existing trees." },
                { m_Setting.GetOptionWarningLocaleID(nameof(TreeControllerSettings.ActivateDisableTreeGrowth)), "This will automatically pause tree growth for all trees other than Lumber. The effects of this setting on existing trees continue even after toggling it off." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TreeControllerSettings.DeactivateDisableTreeGrowth)), "Preseve Age Toggle option available. The effects of this setting on existing trees continue even after deactivating it or settings being reset. You can use the Tree Controller Tool to restart aging for existing trees." },
                { m_Setting.GetOptionWarningLocaleID(nameof(TreeControllerSettings.DeactivateDisableTreeGrowth)), "The effects of this setting on existing trees continue even after deactivating it or settings being reset. You can use the Tree Controller Tool to restart aging for existing trees." },
