...
import { toolbar$1 } from "cs2/bindings";
...
export const TreeControllerComponent: ModuleRegistryExtend = (Component : any) => 
{
    ...
    return (props) => 
    {
        ...
        if (toolbar$1.decorationMode$ === undefined) 
        {
            toolbar$1.setDecorationMode(false);
        }
        const DecorationMode = useValue(toolbar$1.decorationMode$);
